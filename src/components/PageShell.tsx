    ...
    <div className="min-h-screen bg-[#120d0b] text-sand-100 font-sans overflow-x-clip">
      ...
      <footer className="bg-[#0d0907] border-t border-amber-900/20 py-14 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] items-center gap-3 mt-6 text-sand-600 text-xs">
            <p className="whitespace-nowrap">&copy; 2026 Centerpiece Hookah Lounge. All rights reserved.</p>
            <a href="https://getzyrix.com" target="_blank" rel="noopener noreferrer" aria-label="Designed by Get Zyrix" className="flex items-center gap-2 whitespace-nowrap transition-opacity hover:opacity-80">
            ...
            <p className="whitespace-nowrap text-right">Must be 21+ to enter.</p>
          </div>
        </div>
      </footer>
    </div>
